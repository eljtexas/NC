#purpose: to take a tabulated blastn output file (with qseqid sseqid pident qcovs) and filter to 85% identity and 99% query coverage
#also take in the original fasta file and use it to match back and find the full length sequence
#usage: python filter_blastn_output_pident_qcovs_make_fasta_VH.py blastn_tab_output fasta_file_db
