#purpose: take a fasta file and filter for only sequences that contain exact matches to the primer sequences for both forward and reverse to help increase quality of reads
#usage: python primer_matching_fixed.py fwd_primers_fasta rev_primers_fasta fasta_to_filter
