#purpose: take a fasta file and an IMGT nucleotide file and 
#rename the sequence to have the longitudinal timepoint if applicable and the length of the VDJ region
#so that it can easily be split into VDJ and intron for downstream alignment and clustering
#usage: python rename_antibody_length.py fasta_file IMGT_3_nucleotide_file prefix_timepoint_name
